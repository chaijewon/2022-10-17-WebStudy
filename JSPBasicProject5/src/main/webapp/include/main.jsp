...
<%--
            ...
            Cookie 
              ...
              7. 사용처 => 최근 방문 , 장바구니 , 자동 로그인 
                 ...
                 1차 프로젝트 : 웹 흐름파악 (송수신) , 데이터베이스 연결 , 내장객체 사용방법 , 화면 UI , MVC의 사용법 
            ...
            Session
              ***1. 저장 
                 session.setAttribute(키,값)
                                   ...
                                   값:Object저장이 가능 
              2. 저장 기간 
                 session.setMaxInactiveInterval(초단위) ==> default:30분 ==> 경매
              ***3. 읽기 
